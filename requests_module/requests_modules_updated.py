...
class  CsvWriter:
    ...
    def make_to_csv(self)->None:
        with open("C:\\Users\\RG\\Desktop\\projects\\python_exercise\\requests_module\\users_list1.csv", "w", encoding="utf-8") as file_obj:
...
csv_writer=CsvWriter(fetched_data=response_json)
