    ...
    def play_game(self):
        while True:    
            ...
            if user_input == "quit":
                ...
                break 
            elif user_input in RockPaperScissorsGame.options:
            ...
            if not self.play_again():  #function gets call first and returns and that return value is evaluated with conditional stament
                break      
